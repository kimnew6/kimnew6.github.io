...
예) 외부 어플리케이션(위프렉스)은 사용자 인증을 위해 Kakao과 Apple 및 Naver 등의 사용자 인증 방식을 사용합니다. 이 때, OAuth를 바탕으로 제 3자 서비스(위프렉스)는 외부 서비스(Kakao, Apple, Naver)의 특정 자원을 접근 및 사용할 수 있는 권한을 인가받게 됩니다.      
